...
const names = [
    'ㅇㅈㅎ', 'ㄱㄱㅇ', 'ㄱㄴㅎ', 'ㄱㅁㅅ', 'ㄱㅇㅇ', 'ㄱㅈㅊ', 'ㄱㅈㄱ', 'ㄱㅌㅎ',
    'ㄴㄱㄹ', 'ㅁㅈㅎ', 'ㅂㅅㅈ', 'ㅂㅇㅎ', 'ㅂㅈㅎ', 'ㅅㅇㅅ', 'ㅅㅅㅁ',
    'ㅇㅅㅇ', 'ㅇㅅㅁ', 'ㅇㅇㅎ', 'ㅇㅈㅇ', 'ㅇㄱㅈ', 'ㅇㄱㄹ', 'ㅇㅇㅈ', 'ㅇㅈㅊ',
    'ㅇㄷㅂ', 'ㅇㅅㅅ', 'ㅈㅁㅎ', 'ㅈㅇㅈ', 'ㅊㅈㅁ', 'ㅎㅎㅈ', 'ㅇㅇㅅ'
]
...
successButton.addEventListener('click', buttonClickHandler('success-button'))
loveButton.addEventListener('click', buttonClickHandler('love-button'))
